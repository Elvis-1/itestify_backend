    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_scripture', models.ManyToManyField(blank=True, null=True, to=settings.AUTH_USER_MODEL)),
                ('uploaded_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scripture', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='scriptures.scriptures')),
            ],
            options={
                'abstract': False,
            },
