...
from .views import (InspirationalPicturesViewSet, ShowAllInspirationalPicturesStatus, TextTestimonyApprovalView,
                    TextTestimonyListView, TestimonySettingsView, TextTestimonyViewSet, VideoTestimonyDeleteSelected, VideoTestimonyViewSet,
...
urlpatterns = [
    ...
    path('delete-selected-videotestimony/',
         VideoTestimonyDeleteSelected.as_view(), name='hello'),
    path('delete-selected-texttestimony/',
         TextTestimonyDeleteSelected.as_view(), name='hello'),
     path("get-a-commenttexttestimony/<id>/", GetCommentFromATextTestimony.as_view(), name=""),
    path('text-testimonies-detail/<id>/', TextTestimonyDetailView.as_view(),
         name='text-testimonies-detail'),
    path('edit-text-testimonies/<id>/', TextTestimonyDetailView.as_view(),
         name=''),
    ...
    path('testimonies/comment-reply/<id>/',
         TextTestimonyReplyComment.as_view(), name='testimony-text-reply'),
    path('testimonies/get-comment-reply/<id>/',
         TextTestimonyReplyComment.as_view(), name='testimony-text-reply'),
    path('testimonies/all-comment/<id>/',
         TextTestimonyCommentsView.as_view(), name='testimony-by-category-comment'),
     path('testimonies/edit-texttestimony-comment/<id>/',
         editTextTestimonyComment.as_view(), name='testimony-by-category-comment'),
    path('testimonies/text-testimony-like-user-comment/<id>/',
    ...
    path('testimonies/reply-video-comment/<id>/',
         VideoTestimonyReplyComment.as_view(), name='testimony-by-category-comment'),
    ...
    path('testimonies/video-testimony-like-user-comment/<id>/',
         VideoTestimonyLikeUserComment.as_view(), name='testimony-by-category-comment'),
    path('testimonies/get-video-testimony-like-user-comment-count/<id>/',
         VideoTestimonyLikeUserComment.as_view(), name='testimony-by-category-comment'),
    ...
    path('inspirational-pictures-like/<id>/',
         UserLikeInspirationalPicture.as_view(), name='inspirational-pictures-like'),
    path("inspirational-pictures-count/<id>/",
         UserLikeInspirationalPicture.as_view(), name='inspirational-pictures-count'),
]
