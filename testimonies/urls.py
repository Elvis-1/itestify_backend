...
urlpatterns = [
    ...
    path('delete-selected-videotestimony/', VideoTestimonyDeleteSelected.as_view(), name='hello'),
    path('delete-selected-texttestimony/', TextTestimonyDeleteSelected.as_view(), name='hello'),
