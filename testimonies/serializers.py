...
class ReturnTextTestimonySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TextTestimony
        fields = ["id", "title", "category", "content", "status",
                  "rejection_reason", "uploaded_by", "created_at", "updated_at"]


class VideoTestimonySerializer(serializers.ModelSerializer):
    class Meta:
        model = VideoTestimony
        fields = ["title", "category", "source", "upload_status",
                  "scheduled_datetime", "video_file", "thumbnail"]
    ...
    def validate(self, data):
        ...
        scheduled_datetime = data.get(
            "scheduled_datetime", self.instance.scheduled_datetime if self.instance else None)
...
class ReturnVideoTestimonySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = VideoTestimony
        fields = ["id", "title", "category", "source", "upload_status", "video_file", "thumbnail",
                  "rejection_reason", "scheduled_datetime", "uploaded_by", "created_at", "updated_at"]
...
class ReturnInspirationalPicturesSerializer(serializers.ModelSerializer):
    class Meta:
        model = InspirationalPictures
        fields = ["id", "thumbnail", "status", "downloads_count",
                  "uploaded_by", "scheduled_datetime", "created_at", "updated_at"]
